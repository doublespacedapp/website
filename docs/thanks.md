Thank you for buying the premium version.

Your key is on its way by email, from Polar, who handle the payment.
...
If it is not there either, write to [support@doublespaced.app](mailto:support@doublespaced.app) and say which email address you paid with.
Polar's receipt also has a link to your own purchase page, where the key can be looked up again at any time.
