...
Choose it and Greatbook gets an icon in your launcher and its own window, with no tabs and no address bar.

Once installed it works with no internet connection.

This is the same application as the installers, not a cut-down version.
